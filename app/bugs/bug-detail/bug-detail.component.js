...
var BugDetailComponent = (function () {
    function BugDetailComponent(formB, bugService) {
        ...
        this.currentBug = new bug_1.Bug(null, null, null, 1, 1, null, null);
    }
    ...
    BugDetailComponent.prototype.configureForm = function (bug) {
        ...
        // });
        if (bug) {
            this.currentBug = new bug_1.Bug(bug.id, bug.title, bug.description, bug.status, bug.severity, bug.createdBy, bug.createdDate, bug.updatedBy, bug.updatedDate);
        }
    ...
    BugDetailComponent.prototype.cleanBug = function () {
        this.currentBug = new bug_1.Bug(null, null, null, 1, 1, null, null, null, null);
    };
    __decorate([
        core_1.Input(), 
